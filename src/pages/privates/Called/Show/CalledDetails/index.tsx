...
const CalledDetails: React.FC<IProps> = ({ called: calledData }) => {
  const [called] = useState<Called>(calledData);
  ...
  const [estimatedInitiation] = useState<number>(
  ...
  const [estimatedServiceStart] = useState<number>(
  ...
  const [totalInSeconds] = useState<number>(() => {
