...
const HeaderNavigationPrivate: React.FC = () => {
  ...
  return (
    <Container>
      ...
      <NavigationGroup>
        <NavigationItem>
          <LinkMain route={ConfigRoutes.rebox.privates.settings.path}>
            <IoSettings
              size={20}
              title="ícone de configuração"
              color={
                activateMenuBasedOnRoute(
                  ConfigRoutes.rebox.privates.settings.path,
                )
        ...
        <NavigationItem>
          <LinkMain route={ConfigRoutes.rebox.privates.notifications.path}>
            {notification ? (
              <IoNotifications
                size={20}
              ...
              <IoNotifications
                ...
                color={
                  activateMenuBasedOnRoute(
                    ConfigRoutes.rebox.privates.notifications.path,
                  )
                    ? ConfigStyles.rebox.colors.blue.main
                    : ConfigStyles.rebox.colors.black.main
                }
